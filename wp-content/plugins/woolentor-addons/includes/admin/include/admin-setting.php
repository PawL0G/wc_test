                ...
                <div class="different-pro-free">
                    ...
                    <div class="woolentor-admin-row">
                        ...
                        <div class="features-list-area">
                            ...
                            <a class="button button-primary" href="https://hasthemes.com/1ziu" target="_blank"><?php echo esc_html__( 'Buy Now', 'woolenror' ); ?></a>
                        </div>
                    </div>
        ...
        ?>
            <div id="woolentor-dialog" title="<?php esc_html_e( 'Go Premium', 'woolentor' ); ?>" style="display: none;">
                <div class="wldialog-content">
                    ...
                    <p>
                        <?php
                            echo __('Purchase our','woolentor').' <strong><a href="'.esc_url( 'https://hasthemes.com/1ziu' ).'" target="_blank" rel="nofollow">'.__( 'premium version', 'woolentor' ).'</a></strong> '.__('to unlock these pro elements!','woolentor');
                        ?>
                    </p>
                </div>
            </div>
    ...
    function woolentor_html_buy_pro_tabs(){
        ...
        ?>
            ...
            <div id="oneyear" class="woolentor-admin-tab-pane wlactive">
                <div class="woolentor-admin-row">
                    ...
                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/one_year_single_website.png" alt="<?php echo esc_attr__( 'One Year Single Website','woolentor' );?>"></a>
                    </div>

                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/one_year_elementor_guru.png" alt="<?php echo esc_attr__( 'One Year Unlimited Website','woolentor' );?>"></a>
                    </div>

                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/one_year_wpbundle.png" alt="<?php echo esc_attr__( 'One Year Unlimited Websites','woolentor' );?>"></a>
                    </div>
            ...
            <div id="lifetime" class="woolentor-admin-tab-pane">
                ...
                <div class="woolentor-admin-row">
                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/life_time_single_website.png" alt="<?php echo esc_attr__( 'Life Time Single Website','woolentor' );?>"></a>
                    </div>

                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/life_time_elementor_guru.png" alt="<?php echo esc_attr__( 'Life time Unlimited Website','woolentor' );?>"></a>
                    </div>

                    <div class="woolentor-price-plan">
                        <a href="https://hasthemes.com/1ziu" target="_blank"><img src="https://demo.hasthemes.com/pricing-plan/life_time_wpbundle.png" alt="<?php echo esc_attr__( 'Life Time Unlimited Websites','woolentor' );?>"></a>
                    </div>
                </div>
